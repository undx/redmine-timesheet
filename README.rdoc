...
This plugin is based on Eric Davis' original plugin : {redmine-timesheet-plugin}[https://projects.littlestreamsoftware.com/projects/redmine-timesheet].

This plugin is only compatible with Redmine version 2.x and has been tested on Redmine 2.3.
